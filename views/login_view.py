...
class LoginFrame(ctk.CTkFrame):
    """ Frame de Autenticación e Inicio de Sesión Seguro (RF1.1) """
    ...
    def _login(self):
        ...
        if user:
            ...
            self.lbl_error.configure(text="❌ Credenciales incorrectas o usuario inactivo")
